...
import { type StepOneValues, stepOneSchema } from '@/schemas/form'
...
function StepOneForm ({ intlConfig }: { intlConfig: IntlConfig }) {
  ...
  function onSubmit (data: StepOneValues): void {
    console.log(data)
    console.log('✅✅✅✅✅✅✅✅✅✅✅')
  }
  ...
  return (
    <div id='calcula' className="flex flex-col text-[#002446] px-16 bg-[#f7f4f0] pt-10 pb-20">
              ...
              <FormItem>
                <div className='flex items-center'>
                  ...
                  <div className='flex flex-col w-full'>
                    ...
                    <FormDescription className='text-inherit'>
                      Vercel, GitHub, Copilot, Adobe, Shutterstock, Figma, etc.
                    </FormDescription>
                    <FormMessage />
                  </div>
                </div>
                ...
                <FormItem>
                  <div className='flex items-center'>
                    ...
                    <div className='flex flex-col w-full'>
                      ...
                      <FormDescription className={cn('text-inherit', { 'opacity-50': disabledField })}>
                ...
                <FormItem>
                  <div className='flex items-center'>
                    ...
                    <div className='flex flex-col w-full'>
                      <div className='grid grid-cols-2 gap-x-4'>
                        <div className='flex items-center'>
                          <FormLabel className={cn('min-w-max', { 'opacity-50': disabledField })}>Costo Anual</FormLabel>
                          <FormControl>
                            <CurrencyInput
                              className='ml-4 flex h-10 w-full rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 text-end'
                              intlConfig={intlConfig}
